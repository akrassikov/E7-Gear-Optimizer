...
namespace E7_Gear_Optimizer.Ocr
{
    public class ImageManipulation
    {
        ...
        public static Bitmap MakeBlackAndWhite(Bitmap original, float threshold = 0.8f)
        {
            //create a blank bitmap the same size as original
            Bitmap newBitmap = new Bitmap(original.Width, original.Height);
            ...
            //set the color matrix attribute
            attributes.SetColorMatrix(colorMatrix);
            attributes.SetThreshold(threshold); // CHANGE THIS VALUE TO SET MIDDLE BETWEEN WHITE AND BLACK
        ...
        public static Bitmap InvertImageColors(Bitmap original)
        {
            ...
            //create the inverted ColorMatrix
            ColorMatrix colorMatrix = new ColorMatrix(
               new float[][]
               {
                    new float[] {-1, 0, 0, 0, 0},
        ...
        public static Bitmap ChangeBitmapContrastBrightness(Bitmap original, float contrast = 1.0f, float brightness = 1.0f, float gamma = 1.0f)
        {
            //create a blank bitmap the same size as original
            Bitmap newBitmap = new Bitmap(original.Width, original.Height);
